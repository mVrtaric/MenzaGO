            ...
            <div className="flex flex-col gap-3">
              {favRestaurants.map((restaurant, index) => (
                <div
                  ...
                  className="bg-background rounded-2xl p-4 active:scale-[0.98] transition-transform text-left fade-in cursor-pointer"
                  style={{ animationDelay: `${index * 50}ms` }}
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-[#252525] text-sm mb-1.5">{restaurant.name}</h3>
                    ...
                    >
                      <Heart size={14} className="fill-[#ef2723] text-[#ef2723]" />
                    </button>
                  </div>
                </div>
              ))}
